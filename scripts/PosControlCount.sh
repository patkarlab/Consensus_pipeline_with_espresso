...
for ((j=1; j<=${ref}; j++)); do cat /home/pipelines/Consensus_pipeline_with_espresso/scripts/KRAS_wt.fastq; done > ${outfile}.fastq
for ((k=1; k<=${alt}; k++)); do cat /home/pipelines/Consensus_pipeline_with_espresso/scripts/KRAS_rs2135805986_TG.fastq; done >> ${outfile}.fastq
