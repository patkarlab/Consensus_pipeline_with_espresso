...
do 
	...
	#/home/programs/samtools-1.7/samtools mpileup -s -x -BQ 0 -q 1 -d 1000000 --skip-indels -f /home/reference_genomes/hg19_broad/hg19_all.fasta ${i}.abra.bam > ${i}.mpileup
	...
	/usr/lib/jvm/java-8-openjdk-amd64/bin/java -jar /home/programs/VarScan.v2.3.9.jar pileup2cns ${i}".mpileup" --variants SNP --min-coverage 10 --min-reads2 1 --min-avg-qual 30 --min-var-freq 0.0001 --p-value 1 --strand-filter 0 > ${i}".cns"	# These parmeters were taken from the Espresso paper(Abelson et al., Sci. Adv. 2020; 6 : eabe3722)
