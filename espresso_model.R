...
sample_names <- sub('.final.cns','',files) 
#sample_names
...
#    generate_all_models()
  sample_model_input <- filter_model_input(samp, MAF_cutoff = 0.001, VAF_cutoff = 0.05, MAPQ_cutoff = 59, recurrent_mutations = hemeCOSMIC_10)
  samp_models <- generate_all_models(sample_model_input)
  print(samp_name)
  print(samp_models)
