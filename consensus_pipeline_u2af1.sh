...
#Trimming
trimmomatic PE  /home/pipelines/Consensus_pipeline_with_espresso/sequences_250404/${Sample}_*R1_*.fastq.gz /home/pipelines/spresso/sequences_250404/${Sample}_*R2_*.fastq.gz       -baseout ${Sample}.fq.gz  ILLUMINACLIP:/home/programs/Trimmomatic-0.32:30:10:2:keepBothReads         ILLUMINACLIP:/home/programs/Trimmomatic-0.39/adapters/NexteraPE-PE.fa:2:30:10:2:keeIDINGWINDOW:4:15 MINLEN:40
sleep 5s

#FastqToBam
java -Xmx12g -jar "/home/programs/fgbio/fgbio-2.0.1.jar" --compression 1 --async-io FastqToBam --input ${Sample}_1P.fq.gz ${Sample}_2P.fq.gz --read-structures 17S8M+T 20S8M+T --sample ${Sample} --library ${Sample} --output ${Sample}.unmapped.bam
...
# # 
# Coverage
# # /usr/bin/bedtools bamtobed -i ${Sample}.ErrorCorrectd.bam > ${Sample}_trimmed_ErrorCorrected.bed
# # /usr/bin/bedtools coverage -counts -a /home/pipelines/Consensus_pipeline_with_espresso/bedfiles/u2af1_sortd.bed -b ${Sample}_trimmed_ErrorCorrected.bed > "${Sample}_trimmed_umi_cov.regions_bedtools.bed"
# # 
# hsmetrics
# # /usr/lib/jvm/java-8-openjdk-amd64/bin//java -jar /home/programs/picard/build/libs/picard.jar CollectHsMetrics I= ${Sample}.ErrorCorrectd.bam O= ${Sample}_hsmetrics.txt BAIT_INTERVALS= /home/pipelines/Consensus_pipeline_with_espresso/bedfiles/u2af1_sortd.interval_list TARGET_INTERVALS= /home/pipelines/Consensus_pipeline_with_espresso/bedfiles/u2af1_sortd.interval_list R= /home/reference_genomes/hg19_broad/hg19_all.fasta VALIDATION_STRINGENCY=LENIENT
# # 
# Mutect2
